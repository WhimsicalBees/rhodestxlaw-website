...
function map_initialize() {
    var myLatlngCenter = new google.maps.LatLng(29.762692, -95.359288); 
    var myMarker = new google.maps.LatLng(29.762692, -95.359288);
    ...
    if(mapEl) {
        ...
        var marker1 = new google.maps.Marker({
            position: myMarker,
            map: map,
            title:"1313 Main Street Houston, TX 75235",
            icon: 'img/Map_marker.svg.png'
        });
